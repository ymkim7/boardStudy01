	...
	<div id="root">
		...
		<section id="container">
			<form name="updateForm" role="form" method="post" action="/board/replyDelete">
				...
				<div>
					<p>삭제 하시겠습니까?</p>
					<button type="submit" class="deleteBnt" id="deleteBnt" name="deleteBnt">예 삭제합니다.</button>
					<button type="button" class="cancleBnt" id="cancleBnt" name="cancleBnt">아니요</button>
				</div>
			</form>
		</section>
	</div>
